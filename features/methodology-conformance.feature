Feature: methodology conformance
  ...
  Scenario: the verification-conformance rule set reports no match
    ...
    And the rule set carries at least the plank-form, perturbation-quiescence and forbidden-doubles rules
